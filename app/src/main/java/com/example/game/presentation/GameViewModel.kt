...
import com.example.game.data.GameRepositoryImpl
...
import com.example.game.domain.usecases.GetGameSettingsUseCase
...
class GameViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun updateProgress() {
        ...
        _progressAnswers.value = String.format(
            context.resources.getString(R.string.progress_amswers),
            countOfRightAnswers,
